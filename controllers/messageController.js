...
//   const { type, content, cloudinaryPublicId, fileType } = req.body;
...
//     if (uploadedPublicId) {
//       try {
//         await deleteFromCloudinary(uploadedPublicId, fileType || 'image');
//       } catch (cleanupErr) {
//         console.error('[postMessage] Cloudinary rollback failed:', cleanupErr.message);
//       }
//     }
...
//       } catch (rollbackErr) {
//         console.error('[postMessage] Message rollback failed:', rollbackErr.message);
//       }
//     }
...
const editMessage = async (req, res) => {
  ...
  // Validate the incoming content against the message's existing type
