...
const PostCreationComponent = ({ type, initialMention }) => {
  ...
  const recipentOk = initialMention
  ...
  const handlePost = useCallback(async () => {
    ...
    canvasImage, imageSize, imagePosition, aspectRatio, boardTags, pendingAudioFile,
  ])
